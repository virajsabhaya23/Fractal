...
void *compute_image(void *argg) // REMOVED THE FOLLOWING PARAMETERS : // struct bitmap *bm, double xmin, double xmax, double ymin, double ymax, int max, int threads
{
	...
	// CREATES A NEW VARIABLE FROM THE POINTER OF VOID IN ORDER TO USE THE PARAMENTERS LIKE BM,XMIN,XMAX...
	...
	int begin = NewArgg->threadId * height / NumOfThreads;
	int end = begin + height / NumOfThreads;
